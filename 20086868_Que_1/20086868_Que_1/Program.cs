...
namespace PhoneBookConsoleApp
{
    class Program
    {
        ...
        {
            var phoneBook = new PhoneBook(); // Book to Store and Manage Contacts.
            ...
            while (true)
            {
                ...
                Console.WriteLine("Press 'x' to exit"); // Contact Book loop that runs until user presses X to exit
                ...
                switch (userInput)
                {
                    ...
                    default:
                        ...
                        break;     //these are all each operations mentioned in the loop. 
                }
            }
        }
    }
